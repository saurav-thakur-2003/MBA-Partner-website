...
import { E as GraduationCap, H as Award, I as CalendarDays, P as Check, U as ArrowRight, V as BadgeCheck, c as Star, i as Trophy, k as Clock3, l as Sparkles, r as Users, u as ShieldCheck, x as Megaphone } from "../_libs/lucide-react.mjs";
import { t as FAQ } from "./FAQ-CJo438p0.mjs";
import { h as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { t as CTASection } from "./CTASection-DpcuUs9N.mjs";
import { i as programs, r as mentors, t as companyLogos } from "./programs-B_OmzjFp.mjs";
import { t as Route } from "./programs._slug-BYJXsOJD.mjs";
import { n as SuccessStories, t as MentorShowcase } from "./SuccessStories-D7Zt4jJQ.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/programs._slug-DAJhuvd-.js
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "rounded-[2rem] bg-card p-6 shadow-[var(--shadow-card)] lg:col-span-2",
						...
						className: "rounded-[2rem] bg-card p-6 shadow-[var(--shadow-card)]",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "font-display text-3xl font-bold text-primary",
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: program.modules.map((module, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "grid gap-4 rounded-2xl border border-border bg-card p-5 shadow-[var(--shadow-card)] md:grid-cols-[180px_1fr]",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
