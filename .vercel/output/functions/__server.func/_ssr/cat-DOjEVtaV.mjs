...
import { A as FileText, B as ChartColumn, G as Brain, H as Calculator, I as ChevronRight, K as BookOpen, Z as ArrowRight, d as ShieldCheck, i as Users, k as GraduationCap, l as Star, r as Video, s as Target, v as Mic } from "../_libs/lucide-react.mjs";
import { t as FAQ } from "./FAQ-CJo438p0.mjs";
import { h as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { t as CTASection } from "./CTASection-DpcuUs9N.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/cat-DOjEVtaV.js
...
var catTools = [
	{
		icon: FileText,
		title: "Free RCs + 50 sectional mocks",
		desc: "Practice blocks with score tracking and analysis."
	},
	{
		icon: Calculator,
		title: "Percentile vs score calculator",
		desc: "Plan targets and evaluate score bands quickly."
	},
	{
		icon: ChartColumn,
		title: "Safe / ambitious colleges",
		desc: "Shortlist colleges based on profile and exam mix."
	},
	{
		icon: Brain,
		title: "Domain specific Q&A prep",
		desc: "Prepare for interviews with focused question banks."
	},
	{
		icon: Mic,
		title: "10 PIs + 10 GDs",
		desc: "Structured interview and GD practice with feedback."
	},
	{
		icon: Video,
		title: "100+ transcripts",
		desc: "Past year transcripts and mentor walkthroughs."
	},
	{
		icon: Users,
		title: "Top 5 mentors",
		desc: "Mentor credibility plus a 60-second mentor apply flow."
	},
	{
		icon: BookOpen,
		title: "SNAP / NMAT / XAT",
		desc: "Dedicated OMET support and alternate test prep."
	}
];
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: catTools.map((tool) => {
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-3xl border border-border bg-background p-5 shadow-[var(--shadow-card)]",
									children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "inline-flex items-center gap-2 rounded-full bg-primary-soft px-3 py-1 text-xs font-semibold uppercase tracking-wider text-primary",
							children: "Certifications + Mentors"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "mt-3 font-display text-3xl font-bold text-primary sm:text-4xl",
							children: "Excel, Power BI and mentor access"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: certificationCourses.map((course) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "text-xs font-semibold uppercase tracking-[0.3em] text-primary/70",
									children: "Top mentor flow"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "mt-4 rounded-2xl bg-primary-soft p-4 text-sm text-foreground",
									children: "Apply with a 60-second intro video and get considered for the top 5 mentor pool."
								})]
							})]
						})
					]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "inline-flex items-center gap-2 rounded-full bg-primary-soft px-3 py-1 text-xs font-semibold uppercase tracking-wider text-primary",
							children: "College tie-ups"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "mt-3 font-display text-3xl font-bold text-primary sm:text-4xl",
							children: "Current college tie-ups and past results"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-6 grid gap-4 lg:grid-cols-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: tieUps.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: ["• ", item] }, item))
								})]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "rounded-3xl border border-border bg-[linear-gradient(180deg,#101c49_0%,#1f2f78_55%,#616ed0_100%)] p-5 text-white",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "text-xs font-semibold uppercase tracking-[0.3em] text-accent",
										children: "YouTube / GMeet integration"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-4 text-lg font-bold",
										children: "Visible section for live classes, webinars, and community sessions"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "mt-4 flex flex-wrap gap-3",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
											href: "https://youtube.com/@mbapartner?si=0TXLOPjxtMiHvJU7",
											target: "_blank",
											rel: "noreferrer",
