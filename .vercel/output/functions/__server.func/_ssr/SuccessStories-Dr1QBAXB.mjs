...
import { D as GraduationCap, V as Building2, o as TrendingUp, u as Sparkles } from "../_libs/lucide-react.mjs";
import { a as successStories, r as mentors, t as companyLogos } from "./programs-NnSnBEVu.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/SuccessStories-Dr1QBAXB.js
					...
					children: successStories.map((s, index) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: `relative grid h-16 w-16 shrink-0 place-items-center overflow-hidden rounded-2xl bg-gradient-to-br ${gradient} text-white`,
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "text-lg font-black",
											children: initials
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-[radial-gradient(circle_at_30%_30%,rgba(255,255,255,0.35),transparent_35%)]" })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
