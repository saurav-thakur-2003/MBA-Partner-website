...
import { C as Megaphone, J as BadgeCheck, M as Clock3, R as Check, V as CalendarDays, Y as Award, Z as ArrowRight, a as Trophy, d as ShieldCheck, i as Users, k as GraduationCap, l as Star, u as Sparkles } from "../_libs/lucide-react.mjs";
import { t as FAQ } from "./FAQ-Dvm1qVUM.mjs";
import { h as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as ScrollReveal, t as CTASection } from "./CTASection-CnAnrR9s.mjs";
import { i as programs, r as mentors, t as companyLogos } from "./programs-BuXAze3l.mjs";
import { r as pricing } from "./content-DaS0QJAs.mjs";
import { t as Route } from "./programs._slug-DhUcpZaQ.mjs";
import { n as SuccessStories, t as MentorShowcase } from "./SuccessStories-Do0jfVig.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/programs._slug-DWnNGUKz.js
...
function ProgramDetail() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			className: "relative overflow-hidden gradient-navy pt-16 pb-16 text-white section-entrance",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -right-32 top-10 h-96 w-96 rounded-full bg-accent/20 blur-3xl" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute left-10 top-16 h-72 w-72 rounded-full bg-white/10 blur-3xl animate-pulse-soft" }),
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "rounded-2xl border border-white/10 bg-white/10 p-4 transition-transform duration-300 hover:scale-[1.03]",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						className: "rounded-3xl bg-white p-6 text-foreground shadow-(--shadow-elegant) transition-transform duration-300 hover:-translate-y-1",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								id: "enroll",
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollReveal, {
					effect: "scale",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "rounded-4xl border border-border bg-card p-6 shadow-(--shadow-card) transition-transform duration-300 hover:-translate-y-1 hover:shadow-[var(--shadow-elegant)]",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollReveal, {
						effect: "slide-left",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "rounded-4xl bg-card p-6 shadow-(--shadow-card) transition-transform duration-300 hover:-translate-y-1 hover:shadow-[var(--shadow-elegant)] lg:col-span-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
								...
								children: program.whoFor.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-2xl border border-border bg-background p-4 transition-transform duration-300 hover:-translate-y-1 hover:shadow-[var(--shadow-card)]",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						effect: "slide-right",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "rounded-4xl bg-card p-6 shadow-(--shadow-card) transition-transform duration-300 hover:-translate-y-1 hover:shadow-[var(--shadow-elegant)]",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
								className: "font-display text-3xl font-bold text-primary",
								...
								children: program.outcomes.map((outcome) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
									className: "flex items-start gap-2 rounded-2xl bg-primary-soft p-3 text-sm text-foreground/85 transition-transform duration-300 hover:translate-x-1",
