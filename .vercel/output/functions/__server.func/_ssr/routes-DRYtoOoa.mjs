...
import { n as cn, t as Button } from "./button-Tt9GBSDe.mjs";
import { A as FileText, C as Megaphone, E as Linkedin, F as CircleCheck, J as BadgeCheck, K as BookOpen, N as CircleUser, O as Image, P as CirclePlay, Q as ArrowLeft, W as Briefcase, X as ArrowUpRight, Y as Award, Z as ArrowRight, a as Trophy, f as Send, g as PhoneCall, i as Users, k as GraduationCap, l as Star, m as Play, o as TrendingUp, p as Quote, q as Bolt, r as Video, s as Target, u as Sparkles, x as MessageCircleMore, y as MessagesSquare, z as ChartLine } from "../_libs/lucide-react.mjs";
import { t as FAQ } from "./FAQ-Dvm1qVUM.mjs";
import { h as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as ScrollReveal, t as CTASection } from "./CTASection-CnAnrR9s.mjs";
import { i as programs } from "./programs-BuXAze3l.mjs";
import { a as resources, i as prodmarkOffer, n as mentorPasted, o as testimonials, s as trust, t as contactLeads } from "./content-DaS0QJAs.mjs";
import { t as ProgramCard } from "./ProgramCard-BqTs40kc.mjs";
import { n as SuccessStories, t as MentorShowcase } from "./SuccessStories-Do0jfVig.mjs";
import { t as useEmblaCarousel } from "../_libs/embla-carousel-react+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DRYtoOoa.js
...
function TrustStats() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: stats.map(({ icon: Icon, value, label }, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollReveal, {
				delay: index * 80,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
				...
				children: steps.map((step, index) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollReveal, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							className: `group flex w-full items-center gap-4 rounded-xl border p-3 text-left transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[var(--shadow-card)] ${isActive ? "border-accent bg-accent/20 shadow-[var(--shadow-elegant)] scale-[1.01]" : "border-border bg-card hover:border-primary/40 hover:bg-primary-soft/70"}`,
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				className: "rounded-3xl border border-border gradient-navy p-8 text-white shadow-[var(--shadow-elegant)] lg:sticky lg:top-24 lg:h-fit animate-shimmer transition-transform duration-300 hover:-translate-y-1",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: current.points.map((point) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "rounded-2xl border border-white/10 bg-white/10 p-4 text-sm text-white/90 backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:bg-white/15",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "mb-2 h-4 w-4 text-accent" }), point]
						}, point))
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "mt-6 grid grid-cols-3 gap-2",
						children: steps.map((_, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `h-1.5 rounded-full transition-all duration-300 ${index <= active ? "bg-accent shadow-[0_0_16px_rgba(248,246,131,0.55)]" : "bg-white/15"}` }, index))
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
function ResourcesSection() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: resources.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollReveal, {
				delay: index * 80,
				effect: "scale",
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								className: "grid h-11 w-11 place-items-center rounded-2xl bg-accent text-accent-foreground transition-transform duration-300 group-hover:scale-110",
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "The site now includes structured mentor names, colleges, companies, domains, and access-only lead cards."
					})
				] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: mentorPasted.map((mentor) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "grid h-12 w-12 shrink-0 place-items-center rounded-xl bg-[linear-gradient(135deg,#5a67cf_0%,#616ed0_45%,#fbacc3_100%)] text-white shadow-[0_18px_28px_-18px_rgba(90,103,207,0.8)]",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "text-[9px] font-semibold uppercase tracking-[0.28em] text-primary/60",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BadgeCheck, { className: "h-3.5 w-3.5 text-primary" })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							className: "mt-3 inline-flex items-center gap-2 rounded-full border border-[#0a66c2]/20 bg-[#0a66c2]/10 px-3 py-1 text-[11px] font-semibold text-[#0a66c2] transition group-hover:bg-[#0a66c2] group-hover:text-white",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Linkedin, { className: "h-3 w-3" }),
					...
					children: [
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: contactLeads.map((lead) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										className: "mt-3 text-sm text-muted-foreground",
										children: "Access restricted to the internal enrollment team."
									})]
								}, lead.name))
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: prodmarkOffer.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "rounded-2xl border border-border bg-card px-4 py-2.5 text-sm text-muted-foreground",
									children: item
								}, item))
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									children: "The group offer is visible, but the contact data stays private."
								})
							]
						})
					]
...
function AudienceSelector() {
	...
	const recommended = (0, import_react.useMemo)(() => {
		if (selectedAnswers.mba_cat === "CAT / OMET Aspirant" || audience === "cat" || selectedAnswers.preparing_cat === "Yes") return [
	...
	const handleAnswer = (key, value) => {
		...
		if (key === "preparing_cat" && value === "Yes") setAudience("cat");
	};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "rounded-[2rem] border border-border bg-card p-5 shadow-(--shadow-card) sm:p-7",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: (audience === "mba" ? mbaPrograms : catTracks).map((card, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollReveal, {
						delay: index * 90,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "group rounded-3xl border border-border bg-linear-to-br from-primary-soft to-background p-5 transition-all duration-300 hover:-translate-y-2 hover:shadow-(--shadow-elegant) hover:border-primary/30",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-3 text-sm text-muted-foreground",
									children: audience === "mba" ? card.accent : card.note
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									asChild: true,
									variant: "outline",
									className: "mt-4 w-full transition-transform duration-300 hover:-translate-y-0.5",
				...
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollReveal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "rounded-3xl border border-border bg-linear-to-b from-[#0d1830] to-[#142850] p-5 text-white transition-transform duration-300 hover:-translate-y-1",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-4 space-y-3",
							children: recommendations.map((question) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "rounded-2xl border border-white/10 bg-white/5 p-3 transition-all duration-300 hover:border-white/25 hover:bg-white/10",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex items-center gap-2",
									children: [question.key === "mba_cat" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GraduationCap, { className: "h-4 w-4 text-accent" }) : question.key === "placements" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Briefcase, { className: "h-4 w-4 text-accent" }) : question.key === "case_comp" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trophy, { className: "h-4 w-4 text-accent" }) : question.key === "needs_live_projects" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChartLine, { className: "h-4 w-4 text-accent" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BookOpen, { className: "h-4 w-4 text-accent" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: question.answers.map((answer) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										...
										className: `rounded-full px-3 py-1.5 text-xs font-semibold transition-all duration-300 ${selectedAnswers[question.key] === answer ? "bg-accent text-accent-foreground shadow-[0_10px_30px_-12px_rgba(248,246,131,0.95)] scale-105" : "bg-white/10 text-white/80 hover:bg-white/15 hover:scale-105"}`,
										children: answer
									}, answer))
								})]
							}, question.key))
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-5 rounded-2xl border border-white/10 bg-white/5 p-4 transition-all duration-300 hover:border-white/25 hover:bg-white/10",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "text-xs font-semibold uppercase tracking-[0.3em] text-accent",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "inline-flex items-center gap-2 rounded-full bg-primary-soft px-3 py-1 text-xs font-semibold uppercase tracking-wider text-primary",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileText, { className: "h-4 w-4" }), "Brochure assets"]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					className: "mt-3 font-display text-3xl font-bold text-primary sm:text-4xl",
					children: "Live Project and Case Comp brochures"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-2 max-w-3xl text-muted-foreground",
					children: "These are now visible on the website so students can scan the design and open the source material directly."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "relative flex aspect-[4/5] items-center justify-center overflow-hidden bg-[#f6f7fb] p-4",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								src: "/brochures/sample-live-project-brochure.png",
								alt: "Sample Live Project Brochure",
								className: "h-full w-full object-contain object-center"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/70 to-transparent p-5 text-white",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: ["View brochure ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, { className: "h-4 w-4" })]
								})]
							})]
						})
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "grid flex-1 place-items-center bg-[linear-gradient(180deg,#101c49_0%,#1f2f78_55%,#616ed0_100%)] p-8 text-center text-white",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "rounded-3xl border border-white/15 bg-white/10 p-8",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image, { className: "mx-auto h-10 w-10 text-accent" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-4 text-2xl font-black",
										children: "Case Comp Brochure"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-2 text-sm text-white/75",
										children: "PDF version available for direct viewing and download."
									})
								]
							})
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: "Case Competition"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "mt-1 text-lg font-bold text-primary",
								children: "Open brochure PDF"
							})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, { className: "h-5 w-5 text-primary" })]
						})]
					})]
				})
			]
...
function FeaturedVideosStrip() {
	const featured = resources.slice(0, 3);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		className: "container-px mx-auto max-w-7xl py-6",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "rounded-[1.75rem] border border-border bg-card p-4 shadow-[var(--shadow-card)]",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: "Brochure and reference links"
					})] })]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
					href: "/brochures/sample-case-comp-brochure.pdf",
					target: "_blank",
					...
					children: ["Open brochure PDF ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, { className: "h-4 w-4" })]
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-4 grid gap-3 md:grid-cols-3",
				children: featured.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollReveal, {
					delay: index * 80,
					effect: "slide-right",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
						href: item.url,
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "text-[10px] font-semibold uppercase tracking-[0.3em] text-primary/60",
								children: item.type
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "animate-fade-up section-entrance",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
										...
										target: "_blank",
										rel: "noreferrer",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileText, { className: "h-4 w-4" }), " View Case Comp Brochure"]
									})
								})
							]
						}),
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_20%_20%,rgba(255,180,0,0.7),transparent_22%),radial-gradient(circle_at_80%_20%,rgba(255,255,255,0.12),transparent_18%),radial-gradient(circle_at_50%_80%,rgba(255,180,0,0.2),transparent_18%)]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "inline-flex rounded-full bg-accent px-4 py-2 text-xs font-bold text-accent-foreground shadow-lg animate-pulse-soft",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: [
											...
											className: "rounded-xl bg-white/10 p-3 text-center backdrop-blur transition-transform duration-300 hover:scale-105",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "rounded-[1.75rem] border border-white/15 bg-white/10 p-4 shadow-[0_18px_60px_-20px_rgba(0,0,0,0.55)] backdrop-blur-xl transition-transform duration-300 hover:-translate-y-1 hover:scale-[1.01]",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "rounded-[1.75rem] border border-white/15 bg-[linear-gradient(180deg,rgba(248,246,131,0.18),rgba(255,204,182,0.15),rgba(91,103,207,0.25))] p-4 shadow-[0_18px_60px_-20px_rgba(0,0,0,0.45)] backdrop-blur-xl transition-transform duration-300 hover:-translate-y-1 hover:scale-[1.01]",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FeaturedVideosStrip, {}),
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BrochureShowcase, {}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			className: "container-px mx-auto max-w-7xl py-20",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				className: "mt-10 grid items-stretch gap-6 md:grid-cols-2 lg:grid-cols-4",
				children: programs.map((p, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollReveal, {
					delay: index * 90,
					effect: "scale",
