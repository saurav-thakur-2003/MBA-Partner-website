...
//#region node_modules/.nitro/vite/services/ssr/assets/ProgramCard-DZGOaCDK.js
var import_jsx_runtime = require_jsx_runtime();
function ProgramCard({ program, compact = false }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		className: `group relative flex h-full flex-col rounded-2xl border bg-card p-6 shadow-(--shadow-card) transition-all hover:-translate-y-1 hover:shadow-(--shadow-elegant) ${program.highlight ? "border-accent ring-2 ring-accent/30" : "border-border"}`,
		children: [
