...
import { I as Check, Y as ArrowRight, k as Clock, u as Sparkles } from "../_libs/lucide-react.mjs";
import { h as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { r as pricing } from "./content-vHMzH7fA.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/ProgramCard-B9t_JEJ6.js
var import_jsx_runtime = require_jsx_runtime();
function ProgramCard({ program, compact = false }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		className: `group relative flex flex-col rounded-2xl border bg-card p-6 shadow-(--shadow-card) transition-all hover:-translate-y-1 hover:shadow-(--shadow-elegant) ${program.highlight ? "border-accent ring-2 ring-accent/30" : "border-border"}`,
		children: [
