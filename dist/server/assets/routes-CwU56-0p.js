import { n as cn, t as Button } from "./button-CoQ3ZP4A.js";
...
import { ArrowLeft, ArrowRight, BookOpen, Briefcase, CheckCircle2, FileText, GraduationCap, MessagesSquare, Play, Quote, Star, Target, TrendingUp, Trophy, UserCircle, Users } from "lucide-react";
import useEmblaCarousel from "embla-carousel-react";
//#region src/components/TrustStats.tsx
var stats = [
	{
		icon: Users,
		value: "1,500+",
...
//#endregion
//#region src/components/Roadmap.tsx
var steps = [
	{
		icon: UserCircle,
			...
			children: [/* @__PURE__ */ jsx("ol", {
				...
				children: steps.map((s, i) => {
					...
					return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("button", {
						...
						children: [
							...
							/* @__PURE__ */ jsx(Icon, { className: `h-4 w-4 shrink-0 ${isActive ? "text-accent" : "text-muted-foreground"}` })
						]
					}) }, s.title);
				})
			}), /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: (() => {
								...
								return /* @__PURE__ */ jsx(ActiveIcon, { className: "h-6 w-6" });
							})()
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: steps.map((_, i) => /* @__PURE__ */ jsx("div", { className: `h-1.5 rounded-full transition-all ${i <= active ? "bg-accent" : "bg-white/15"}` }, i))
					}),
					/* @__PURE__ */ jsx("p", {
...
//#endregion
//#region src/components/VideoTestimonials.tsx
var testimonials = [
	{
		name: "Riya Agarwal",
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: /* @__PURE__ */ jsxs(Carousel, {
				...
				children: [/* @__PURE__ */ jsx(CarouselContent, { children: testimonials.map((t, i) => /* @__PURE__ */ jsx(CarouselItem, {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsx("button", {
									...
									children: /* @__PURE__ */ jsx(Play, { className: "h-6 w-6 fill-current" })
								})
							}), /* @__PURE__ */ jsxs("div", {
							...
							className: "p-5",
							children: [/* @__PURE__ */ jsx(Quote, { className: "h-5 w-5 text-accent" }), /* @__PURE__ */ jsxs("p", {
					...
					children: [/* @__PURE__ */ jsx(CarouselPrevious, { className: "static translate-y-0" }), /* @__PURE__ */ jsx(CarouselNext, { className: "static translate-y-0" })]
				})]
			})
		})]
	});
	...
	return /* @__PURE__ */ jsxs("div", { children: [
		/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", { className: "absolute -top-32 left-1/3 h-96 w-96 rounded-full bg-accent/10 blur-3xl" }), /* @__PURE__ */ jsx("div", { className: "absolute right-0 top-40 h-96 w-96 rounded-full bg-primary/10 blur-3xl" })]
			}), /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Star, { className: "h-3.5 w-3.5 fill-accent text-accent" }), "Trusted by 1,500+ MBA students · 4.9/5 rating"]
						}),
						/* @__PURE__ */ jsxs("h1", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Button, {
								...
								children: /* @__PURE__ */ jsxs(Link, {
									to: "/programs",
									children: ["Explore Programs ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-5 w-5" })]
								})
							}), /* @__PURE__ */ jsx(Button, {
								asChild: true,
								variant: "outline",
								...
								children: /* @__PURE__ */ jsxs("a", {
									href: "#stories",
									children: [/* @__PURE__ */ jsx(Play, { className: "h-4 w-4" }), " Watch Success Stories"]
								})
							})]
						}),
						/* @__PURE__ */ jsx("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx(Button, {
										...
										children: /* @__PURE__ */ jsxs(Link, {
											...
											children: ["Enroll Now · ₹39,999 ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
										})
									}),
									/* @__PURE__ */ jsx("div", {
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
					...
					children: /* @__PURE__ */ jsxs(Link, {
						to: "/compare",
						children: ["Compare All ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
					})
				})]
			}), /* @__PURE__ */ jsx("div", {
		...
		/* @__PURE__ */ jsx(VideoTestimonials, {}),
		/* @__PURE__ */ jsx(FAQ, { items: homeFaqs }),
