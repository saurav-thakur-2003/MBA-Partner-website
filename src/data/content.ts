...
export const pricing = {
  ...
  liveProjects: [
    { title: "1 Domain, 1 Month", price: "₹4,000", was: "₹4,500" },
    { title: "2 Domains, 1 Month", price: "₹7,500", was: "₹7,999" },
  ],
  ...
  certifications: [
    { title: "Advanced Excel", price: "₹1,199", was: "₹1,499" },
    { title: "Power BI Certification", price: "₹1,499" },
  ],
  allInOneCombo2: {
