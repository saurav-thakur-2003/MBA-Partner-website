  ...
  head: () => ({
    meta: [
      ...
      { title: "MBA Partner — India's Career Acceleration Platform for MBA Students" },
      {
        name: "description",
        content:
          "Mentorship, live projects, case competitions and placement preparation for MBA students from IIMs, XLRI, SPJIMR, NMIMS, Symbiosis and beyond.",
      },
      { name: "author", content: "MBA Partner" },
